...
public class ProcesarProveedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String msj = null;
        try {
            prov.setCodigoProveedor(Integer.parseInt(request.getParameter("txtCode")));
            prov.setNombre(request.getParameter("txtName"));
            prov.setDireccion(request.getParameter("txtAddress"));
            prov.setTelefono(request.getParameter("txtTel"));
